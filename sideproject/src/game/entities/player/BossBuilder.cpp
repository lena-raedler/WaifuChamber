    ...
    void buildBoss(int id, std::pair<int, int> pos){
        ...
        switch(id){
            ...
            case 4:
                ...
                b.addHealthBar(300, {0xFF, 0x80, 0x80, 0xFF}, {0xFF, 0x00, 0x00, 0xFF});
                b.addHealthBar(250, {0x80, 0xFF, 0x80, 0xFF}, {0x00, 0xFF, 0x00, 0xFF});
                b.addHealthBar(250, {0x80, 0x80, 0xff, 0xFF}, {0x00, 0x00, 0xFF, 0xFF});
